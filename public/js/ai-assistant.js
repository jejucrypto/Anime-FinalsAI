...
// Update the initial chat history
let chatHistory = [
  { 
    role: 'assistant', 
    content: "Hello! I'm your Anime Assistant. I can help you with:\n\n" +
...
const systemMessage = {
  role: "system",
  content: `You are an anime expert assistant for Anime Heaven website. 
            The user is currently on the ${currentPage.replace('.html', '')} page. 
            Provide helpful information relevant to their current context.`
};
...
async function sendMessage() {
  ...
  try {
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer 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`,
        ...
        messages: [
          {
            role: "system",
            content: "You are an anime expert assistant for Anime Heaven website. " +
                     "Provide helpful information about anime series, movies, characters, and recommendations. " +
                     "Keep responses concise but informative. " +
                     "When recommending anime, mention similar shows. " +
